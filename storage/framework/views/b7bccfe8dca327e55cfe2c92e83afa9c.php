    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-2 col-md-4 mb-4 mb-md-0">
                ...
                <a href="<?php echo e(url('/universita')); ?>" class="footer-link">Universit&agrave;</a>
                <a href="<?php echo e(url('/certificazioni')); ?>" class="footer-link">Certificazioni</a>
                <a href="<?php echo e(url('/orientamento')); ?>" class="footer-link">Orientamento</a>
            </div>
            <div class="col-lg-2 col-md-4 mb-4 mb-md-0">
                <h5 class="mb-4 h6 text-uppercase">Informazioni</h5>
                <a href="<?php echo e(url('/chi-siamo')); ?>" class="footer-link">Chi Siamo</a>
                <a href="<?php echo e(url('/contatti')); ?>" class="footer-link">Contatti</a>
                <a href="<?php echo e(url('/privacy-policy')); ?>" class="footer-link">Privacy Policy</a>
                <a href="<?php echo e(url('/termini-servizio')); ?>" class="footer-link">Termini di Servizio</a>
            </div>
        ...
        <div class="footer-bottom text-center">
            <p>&copy; <?php echo e(date('Y')); ?> Coreform - Tutti i diritti riservati</p>
        </div>
    </div>
</footer><?php /**PATH /var/www/coreform/resources/views/components/footer.blade.php ENDPATH**/ ?>