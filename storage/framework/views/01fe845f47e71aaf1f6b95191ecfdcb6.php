            ...
            <div class="mb-4">
                ...
                <div class="d-flex justify-content-between align-items-center mt-5">
                    ...
                    <div>
                        ...
                        <img src="<?php echo e(asset('images/certificazioni/scalapay.png')); ?>" alt="Logo Scalapay" class="img-fluid mt-2">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <del class="text-muted me-3">&euro; <?php echo e(number_format($certificazione['prezzo_originale'], 2, ',', '.')); ?></del>
                        <h3 class="mb-0">&euro; <?php echo e(number_format($certificazione['prezzo_scontato'], 2, ',', '.')); ?></h3>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/coreform/resources/views/pages/certificazione-dettaglio.blade.php ENDPATH**/ ?>