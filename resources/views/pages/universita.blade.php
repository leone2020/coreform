...
@section('title', 'Università - Coreform')

@section('content')
<!-- Header immagine a tutto schermo -->
<div class="position-relative mb-5">
    <div class="ratio ratio-21x9">
        <img src="{{ asset('images/universita-header.jpg') }}" class="img-fluid" alt="Università" style="object-fit: cover; width: 100%; max-height: 400px;">
    </div>
