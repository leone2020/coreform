...
@section('title', 'Coreform - La piattaforma per orientarti verso il tuo futuro universitario')
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <div class="hero-buttons d-flex gap-3">
                    <a href="{{ url('/orientamento') }}" class="btn btn-light">Esplora Percorsi</a>
                    <a href="{{ url('/chi-siamo') }}" class="btn btn-outline-light">Scopri di Pi&ugrave;</a>
                </div>
            </div>
            <div class="col-lg-6 mt-5 mt-lg-0 text-center hero-image">
                <img src="{{ asset('images/studenti-universitari.png') }}" alt="Studenti universitari" class="img-fluid rounded-3">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="feature-card">
                    ...
                    <a href="{{ url('/orientamento') }}" class="btn btn-outline-primary">Scopri di pi&ugrave;</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-card">
                    ...
                    <a href="{{ url('/universita') }}" class="btn btn-outline-primary">Scopri di pi&ugrave;</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature-card">
                    ...
                    <a href="{{ url('/certificazioni') }}" class="btn btn-outline-primary">Acquista il corso</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card testimonial-card h-100">
                    <img src="{{ asset('images/economia.svg') }}" class="card-img" alt="Economia e Management">
            ...
            <div class="col-md-4">
                <div class="card testimonial-card h-100">
                    <img src="{{ asset('images/umanistiche.svg') }}" class="card-img" alt="Scienze Umanistiche">
                    <div class="card-img-overlay">
            ...
            <div class="col-md-4">
                <div class="card testimonial-card h-100">
                    <img src="{{ asset('images/ingegneria.svg') }}" class="card-img" alt="Ingegneria">
                    <div class="card-img-overlay">
...
<section class="cta-section">
    ...
    <div class="container text-center cta-content">
        ...
        <a href="{{ url('/inizia') }}" class="btn btn-light">Inizia Ora</a>
    </div>
</section>
@endsection